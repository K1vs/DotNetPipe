...
public interface IForkStep<TInput, TResult, TBranchAInput, TBranchAResult, TBranchBInput, TBranchBResult> : IStep
{
    ...
    /// </summary>
    TResult Handle(TInput input, Handler<TBranchAInput, TBranchAResult> branchANext, Handler<TBranchBInput, TBranchBResult> branchBNext, CancellationToken ct = default);
