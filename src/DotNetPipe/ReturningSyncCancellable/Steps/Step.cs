...
/// <summary>
/// Base class for all steps in a returning cancellable pipeline.
/// </summary>
public abstract class Step
{
    ...
    /// <exception cref="InvalidOperationException">Thrown when the entry step is already set to another step.</exception>
