...
public delegate TResult IfSelector<TInput, TResult, TIfInput, TIfResult, TNextInput, TNextResult>(
    TInput input,
...
/// <param name="ct">The cancellation token to observe.</param>
/// <returns>The result of the operation.</returns>
public delegate TResult Pipe<TInput, TResult, out TNextInput, TNextResult>(
    TInput input,
    Handler<TNextInput, TNextResult> next,
    CancellationToken ct = default);
...
/// <param name="ct">The cancellation token to observe.</param>
/// <returns>The result of the operation.</returns>
public delegate TResult Handler<in TInput, TResult>(
    TInput input,
    CancellationToken ct = default);
