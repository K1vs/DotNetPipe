...
public interface ISwitchStep<TInput, TResult, TCaseInput, TCaseResult, TDefaultInput, TDefaultResult, TNextInput, TNextResult> : IStep
{
    ...
    /// </summary>
    ValueTask<TResult> Handle(TInput input, IReadOnlyDictionary<string, Handler<TCaseInput, TCaseResult>> cases, Handler<TDefaultInput, TDefaultResult> defaultNext, CancellationToken ct = default);
