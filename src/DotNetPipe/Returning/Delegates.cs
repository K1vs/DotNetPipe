...
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate ValueTask<TResult> Pipe<TInput, TResult, out TNextInput, TNextResult>(TInput input, Handler<TNextInput, TNextResult> next);
...
/// <param name="input">The input data to be processed.</param>
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate ValueTask<TResult> Handler<in TInput, TResult>(TInput input);