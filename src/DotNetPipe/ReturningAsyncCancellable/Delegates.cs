...
public delegate Task<TResult> IfSelector<TInput, TResult, TIfInput, TIfResult, TNextInput, TNextResult>(
    TInput input,
...
/// <param name="ct">The cancellation token to observe.</param>
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate Task<TResult> Pipe<TInput, TResult, out TNextInput, TNextResult>(
    TInput input,
    Handler<TNextInput, TNextResult> next,
    CancellationToken ct = default);
...
/// <param name="ct">The cancellation token to observe.</param>
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate Task<TResult> Handler<in TInput, TResult>(
    TInput input,
    CancellationToken ct = default);
