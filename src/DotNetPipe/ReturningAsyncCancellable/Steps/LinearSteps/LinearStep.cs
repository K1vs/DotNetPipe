...
namespace K1vs.DotNetPipe.ReturningAsyncCancellable.Steps.LinearSteps;
    ...
    ReducedPipeStep<TEntryStepInput, TEntryStepResult, TNextInput, TNextResult>
{
    ...
    /// <summary>
    /// Mutators for the step pipe. These allow for modifying the behavior of the step dynamically.
    /// </summary>
