...
public delegate Task<TResult> IfSelector<TInput, TResult, TIfInput, TIfResult, TNextInput, TNextResult>(TInput input,
...
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate Task<TResult> IfElseSelector<TInput, TResult, TIfInput, TIfResult, TElseInput, TElseResult>(
    TInput input,
    Handler<TIfInput, TIfResult> ifNext,
...
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate Task<TResult> SwitchSelector<TInput, TResult, TCaseInput, TCaseResult, TDefaultInput, TDefaultResult>(
    TInput input,
...
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate Task<TResult> ForkSelector<TInput, TResult, TBranchAInput, TResultA, TBranchBInput, TResultB>(
    TInput input,
...
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate Task<TResult> MultiForkSelector<TInput, TResult, TBranchesInput, TBranchesResult, TDefaultInput, TDefaultResult>(
    TInput input,
...
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate Task<TResult> Pipe<TInput, TResult, out TNextInput, TNextResult>(TInput input, Handler<TNextInput, TNextResult> next);
...
/// <param name="input">The input data to be processed.</param>
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate Task<TResult> Handler<in TInput, TResult>(TInput input);
