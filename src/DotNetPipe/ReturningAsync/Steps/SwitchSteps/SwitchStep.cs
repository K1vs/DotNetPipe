namespace K1vs.DotNetPipe.ReturningAsync.Steps.SwitchSteps;
...
public abstract class SwitchStep<TEntryStepInput, TEntryStepResult, TInput, TResult, TCaseInput, TCaseResult, TDefaultInput, TDefaultResult, TNextStepInput, TNextStepResult> : ReducedPipeStep<TEntryStepInput, TEntryStepResult, TNextStepInput, TNextStepResult>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SwitchStep{TEntryStepInput, TEntryStepResult, TInput, TResult, TCaseInput, TCaseResult, TDefaultInput, TDefaultResult, TNextStepInput, TNextStepResult}"/> class.
    /// </summary>
