...
namespace K1vs.DotNetPipe.ReturningAsync.Steps.IfElseSteps;
...
public abstract class IfElseStep<TEntryStepInput, TEntryStepResult, TInput, TResult, TIfInput, TIfResult, TElseInput, TElseResult, TNextStepInput, TNextStepResult> : ReducedPipeStep<TEntryStepInput, TEntryStepResult, TNextStepInput, TNextStepResult>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="IfElseStep{TEntryStepInput, TEntryStepResult, TInput, TResult, TIfInput, TIfResult, TElseInput, TElseResult, TNextStepInput, TNextStepResult}"/> class.
    /// </summary>
