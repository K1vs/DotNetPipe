...
/// <param name="ct">The cancellation token to observe while waiting for the task to complete.</param>
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate ValueTask Pipe<TInput, out TNextInput>(TInput input, Handler<TNextInput> next, CancellationToken ct = default);
...
/// <param name="ct">The cancellation token to observe while waiting for the task to complete.</param>
/// <returns>A value task representing the asynchronous operation.</returns>
public delegate ValueTask Handler<in TInput>(TInput input, CancellationToken ct = default);