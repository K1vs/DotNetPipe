using K1vs.DotNetPipe.Async.Steps.ForkSteps;
using K1vs.DotNetPipe.Async.Steps.HandlerSteps;
using K1vs.DotNetPipe.Async.Steps.IfElseSteps;
using K1vs.DotNetPipe.Async.Steps.IfSteps;
using K1vs.DotNetPipe.Async.Steps.LinearSteps;
using K1vs.DotNetPipe.Async.Steps.MultiForkSteps;
using K1vs.DotNetPipe.Async.Steps.SwitchSteps;
...
public class PipelineEntry<TPipelineInput>
{
    ...
    /// <returns>An instance of <see cref="EntrySwitchStep{TPipelineInput, TCaseInput, TDefaultInput, TNextInput}"/> representing the switch step.</returns>
    public EntrySwitchStep<TPipelineInput, TCaseInput, TDefaultInput, TNextInput> StartWithSwitch<TCaseInput, TDefaultInput, TNextInput>(ISwitchStep<TPipelineInput, TCaseInput, TDefaultInput, TNextInput> step)
    {
