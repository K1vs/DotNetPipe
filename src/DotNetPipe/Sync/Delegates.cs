...
public delegate void IfSelector<TInput, TIfInput, TNextInput>(TInput input,
...
public delegate void IfElseSelector<TInput, TIfInput, TElseInput>(TInput input,
    Handler<TIfInput> ifNext,
...
public delegate void SwitchSelector<TInput, TCaseInput, TDefaultInput>(TInput input,
...
public delegate void ForkSelector<TInput, TBranchAInput, TBranchBInput>(TInput input,
...
public delegate void MultiForkSelector<TInput, TBranchesInput, TDefaultInput>(TInput input,
...
public delegate void Pipe<TInput, out TNextInput>(TInput input, Handler<TNextInput> next);
...
/// <typeparam name="TInput">The type of the input data.</typeparam>
/// <param name="input">The input data to be processed.</param>
public delegate void Handler<in TInput>(TInput input);