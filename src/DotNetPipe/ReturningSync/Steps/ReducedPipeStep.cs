using K1vs.DotNetPipe.ReturningSync.Steps.ForkSteps;
using K1vs.DotNetPipe.ReturningSync.Steps.HandlerSteps;
using K1vs.DotNetPipe.ReturningSync.Steps.IfElseSteps;
using K1vs.DotNetPipe.ReturningSync.Steps.IfSteps;
using K1vs.DotNetPipe.ReturningSync.Steps.LinearSteps;
using K1vs.DotNetPipe.ReturningSync.Steps.MultiForkSteps;
using K1vs.DotNetPipe.ReturningSync.Steps.SwitchSteps;

namespace K1vs.DotNetPipe.ReturningSync.Steps;
