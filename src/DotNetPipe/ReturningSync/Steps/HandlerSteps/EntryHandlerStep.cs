namespace K1vs.DotNetPipe.ReturningSync.Steps.HandlerSteps;
...
public sealed class EntryHandlerStep<TEntryStepInput, TEntryStepResult> : HandlerStep<TEntryStepInput, TEntryStepResult, TEntryStepInput, TEntryStepResult>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EntryHandlerStep{TEntryStepInput, TEntryStepResult}"/> class.
    /// </summary>
