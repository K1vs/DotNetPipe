...
public delegate TResult IfSelector<TInput, TResult, TIfInput, TIfResult, TNextInput, TNextResult>(TInput input,
...
/// <returns>A result of the operation.</returns>
public delegate TResult IfElseSelector<TInput, TResult, TIfInput, TIfResult, TElseInput, TElseResult>(
    TInput input,
    Handler<TIfInput, TIfResult> ifNext,
...
/// <returns>A result of the operation.</returns>
public delegate TResult SwitchSelector<TInput, TResult, TCaseInput, TCaseResult, TDefaultInput, TDefaultResult>(
    TInput input,
...
/// <returns>A result of the operation.</returns>
public delegate TResult ForkSelector<TInput, TResult, TBranchAInput, TResultA, TBranchBInput, TResultB>(
    TInput input,
...
/// <returns>A result of the operation.</returns>
public delegate TResult MultiForkSelector<TInput, TResult, TBranchesInput, TBranchesResult, TDefaultInput, TDefaultResult>(
    TInput input,
...
/// <returns>A result of the operation.</returns>
public delegate TResult Pipe<TInput, TResult, out TNextInput, TNextResult>(TInput input, Handler<TNextInput, TNextResult> next);

/// <summary>
/// Delegate for a handler that processes an input and returns a result.
/// </summary>
/// <typeparam name="TInput">The type of the input data.</typeparam>
/// <typeparam name="TResult">The type of the result produced by the handler.</typeparam>
/// <param name="input">The input data to be processed.</param>
/// <returns>A result of the operation.</returns>
public delegate TResult Handler<in TInput, TResult>(TInput input);
