...
public interface IMultiForkStep<TInput, TResult, TBranchesInput, TBranchesResult, TDefaultInput, TDefaultResult> : IStep
{
    ...
    TResult Handle(TInput input, IReadOnlyDictionary<string, Handler<TBranchesInput, TBranchesResult>> branches, Handler<TDefaultInput, TDefaultResult> defaultNext);
