...
public class TestReturningCancellablePipeline
{
    ...
    {
        _pipeline = Pipelines.CreateReturningAsyncCancellablePipeline<int, int>("TestPipeline")
            .StartWithHandler("TestHandler", handler)
            .BuildPipeline();
    }

    public async Task<int> Run(int input, CancellationToken ct)
    {
...
public class TestReturningCancellableTwoStepPipeline
{
    ...
    {
        _space = Pipelines.CreateReturningAsyncCancellableSpace();
        _handler = handler;
    }

    public async Task<int> Run(int input, int constantToAdd, CancellationToken ct)
    {
...
public class TestReturningCancellableThreeStepPipeline
{
    ...
    public async Task<int> Run(int input, int constantToAdd, int multiplier, CancellationToken ct)
    {
...
{
    private readonly Func<string, int, CancellationToken, Task<int>> _pipeline;
    ...
    public async Task<int> Run(string input, int constantToAdd, CancellationToken ct)
    {
...
{
    private readonly Func<string, int, int, CancellationToken, Task<int>> _pipeline;
    ...
    public async Task<int> Run(string input, int constantToAdd, int multiplier, CancellationToken ct)
    {
...
{
    private readonly Func<string, CancellationToken, Task<int>> _pipeline;
    ...
    public async Task<int> Run(string input, CancellationToken ct)
    {
...
{
    private readonly Func<string, CancellationToken, Task<(int?, string?)>> _pipeline;

    public TestReturningCancellableForkStepPipeline()
    {
        var compiled = Pipelines.CreateReturningAsyncCancellablePipeline<string, (int?, string?)>("TestForkPipeline")
    ...
    public async Task<(int?, string?)> Run(string input, CancellationToken ct)
    {
        return await _pipeline(input, ct);
    }
}
...
{
    private readonly Func<string, CancellationToken, Task<(int?, string?, char[]?)>> _pipeline;
    ...
    public async Task<(int?, string?, char[]?)> Run(string input, CancellationToken ct)
    {
        return await _pipeline(input, ct);
    }
}
