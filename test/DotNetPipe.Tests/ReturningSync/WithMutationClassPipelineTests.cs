...
public class WithMutationClassReturningPipelineTests
{
    ...
    public void BuildAndRunPipeline_WhenIfStepHandlesIntAndFloat_ShouldReturn(string inputValue, int expected)
    {
        ...
        var result = test.Run(inputValue);
        Assert.Equal(expected, result);
    }
...
public class TestReturningClassHandlerStep : IHandlerStep<int, int>
{
    ...
    public int Handle(int input) => input;
}
...
public class TestReturningClassLinearStep : ILinearStep<int, int, int, int>
{
    ...
    public int Handle(int input, Handler<int, int> next)
    {
...
public class TestReturningClassTrimStep : ILinearStep<string, int, string, int>
{
    ...
    public int Handle(string input, Handler<string, int> next)
    {
...
public class TestReturningClassIfStep : IIfStep<string, int, string, int, int, int>
{
    ...
    public int Handle(string input, Handler<string, int> ifNext, Handler<int, int> next)
    {
    ...
    public OpenPipeline<string, int, int, int> BuildTruePipeline(Space space)
    {
        return space.CreatePipeline<string, int>("FloatProcessing")
            .StartWithLinear<double, int>("ParseFloat", (val, nxt) =>
            {
                if (double.TryParse(val, out var f)) return nxt(f);
                return 0;
            })
            .ThenLinear<int, int>("RoundToInt", (val, nxt) =>
            {
...
{
    public string Name => "CheckIntOrFloat";
    public int Handle(string input, Handler<string, int> ifNext, Handler<int, int> elseNext)
    {
        if (int.TryParse(input, out var intValue))
        {
            return elseNext(intValue);
        }
        return ifNext(input);
    }
    public OpenPipeline<string, int, int, int> BuildTruePipeline(Space space)
    ...
    public OpenPipeline<int, int, int, int> BuildFalsePipeline(Space space)
    {
        return space.CreatePipeline<int, int>("IntProcessing")
            .StartWithLinear<int, int>("Multiply", (val, nxt) =>
            {
                var result = val * 2;
                return nxt(result);
            })
...
public class TestReturningClassPipeline
{
    ...
    public int Run(int input) => _compiled(input);
}
...
public class TestReturningClassIfStepPipeline
{
    ...
    public int Run(string input) => _compiled(input);
}
...
public class TestReturningClassIfTrimMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, int, string, int>>("TrimStringMutator", 1, pipe => (input, next) => pipe(input, next));
...
public class TestReturningClassIfSelectorMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<IfSelector<string, int, string, int, int, int>>("CheckIntOrFloatMutator", 1, sel => (input, ifNext, next) => ifNext(input));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassIfRoundToIntMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<double, int, int, int>>("RoundToIntMutator", 1, pipe => (input, next) =>
        {
            input += 1;
...
public class TestReturningClassIfAddConstantMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<int, int, int, int>>("AddConstantMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassIfHandlerMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Handler<int, int>>("TestHandlerMutator", 1, handler => input => handler(input));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassIfElseSelectorMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<IfElseSelector<string, int, string, int, int, int>>("CheckIntOrFloatMutator", 1, sel => (input, trueNext, falseNext) =>
        {
            if (int.TryParse(input, out _))
            {
                return trueNext(input);
            }
            else
            {
                return falseNext(0);
...
public class TestReturningClassIfElseParseFloatMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, int, double, int>>("ParseFloatMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassIfElseMultiplyMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<int, int, int, int>>("IntProcessingMutator", 1, pipe => (input, next) =>
        {
            input += 2;
...
public class TestReturningClassIfElseHandlerMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Handler<int, int>>("TestHandlerMutator", 1, handler => input =>
        {
            input += 1;
...
public class TestReturningClassSwitchSelectorMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<SwitchSelector<string, int, int, int, int, int>>("NumberRangeSwitchMutator", 1, selector => (input, cases, defaultNext) =>
        {
            if (int.TryParse(input, out var number))
            {
                if (number > 50) return cases["GreaterThan100"](number);
                if (number > 0) return cases["BetweenZeroAndHundred"](number);
...
public class TestReturningClassSwitchMultiplyByThreeMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<int, int, int, int>>("MultiplyByThreeMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassSwitchAddTwoMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<int, int, int, int>>("AddTwoMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassSwitchMultiplyByTwoMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<int, int, int, int>>("MultiplyByTwoMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassSwitchKeepZeroMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<int, int, int, int>>("KeepZeroMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassSwitchStringLengthMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<int, int, int, int>>("StringLengthMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassDigitContentForkStep : IForkStep<string, (int?, string?), string, (int?, string?), string, (int?, string?)>
{
    ...
    public (int?, string?) Handle(string input, Handler<string, (int?, string?)> digitBranch, Handler<string, (int?, string?)> nonDigitBranch)
    {
        var onlyDigits = !string.IsNullOrEmpty(input) && input.All(char.IsDigit);
        return onlyDigits ? digitBranch(input) : nonDigitBranch(input);
    }
    public Pipeline<string, (int?, string?)> BuildBranchAPipeline(Space space)
    {
        return space.CreatePipeline<string, (int?, string?)>("DigitProcessing")
            ...
            {
                if (int.TryParse(input, out var number)) return next(number);
                return next(0);
            })
...
public class TestReturningClassForkStepPipeline
{
    ...
    public (int?, string?) Run(string input) => _compiled(input);
}
...
public class TestReturningClassForkTrimMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, (int?, string?), string, (int?, string?)>>("TrimStringMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassForkSelectorMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<ForkSelector<string, (int?, string?), string, (int?, string?), string, (int?, string?)>>("DigitContentForkMutator", 1, selector => (input, digitBranch, nonDigitBranch) =>
        {
            if (input.Length > 3) return digitBranch(input);
...
public class TestReturningClassForkRemoveNonDigitsMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, (int?, string?), string, (int?, string?)>>("RemoveNonDigitsMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassForkParseToIntMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, (int?, string?), int, (int?, string?)>>("ParseToIntMutator", 1, pipe => (input, next) =>
        {
            if (int.TryParse(input, out var number)) return next(number + 5);
            return next(0 + 5);
        });
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
...
public class TestReturningClassForkIntHandlerMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Handler<int, (int?, string?)>>("IntHandlerMutator", 1, handler => input => handler(input));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassForkRemoveDigitsMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, (int?, string?), string, (int?, string?)>>("RemoveDigitsMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassForkAddSpacesMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, (int?, string?), string, (int?, string?)>>("AddSpacesMutator", 1, pipe => (input, next) =>
        {
...
public class TestReturningClassForkStringHandlerMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Handler<string, (int?, string?)>>("StringHandlerMutator", 1, handler => input => handler(input));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassMultiForkStep : IMultiForkStep<string, (int?, string?, char[]?), string, (int?, string?, char[]?), char[], (int?, string?, char[]?)>
{
    ...
    public (int?, string?, char[]?) Handle(string input,
        ...
        Handler<char[], (int?, string?, char[]?)> defaultNext)
    {
        ...
        if (onlyDigits) return branches["DigitBranch"](input);
        if (onlyLetters) return branches["LetterBranch"](input);
        if (onlySpecial) return branches["SpecialCharBranch"](input);
...
public class TestReturningClassMultiForkStepPipeline
{
    ...
    public TestReturningClassMultiForkStepPipeline(IEnumerable<IMutator<Space>> mutators)
    {
        ...
        space.CreatePipeline<string, (int?, string?, char[]?)>("DigitProcessingPipeline")
            .StartWithLinear<int?, (int?, string?, char[]?)>("ParseStringToInt", (input, next) => next(int.TryParse(input, out var n) ? n : 0))
        ...
        space.CreatePipeline<string, (int?, string?, char[]?)>("SpecialCharProcessingPipeline")
            .StartWithLinear<string, (int?, string?, char[]?)>("RemoveWhitespace", (input, next) => next(new string(input.Where(c => !char.IsWhiteSpace(c)).ToArray())))
            .ThenLinear<char[], (int?, string?, char[]?)>("ConvertToCharArray", (input, next) => next(input.ToCharArray()))
    ...
    public (int?, string?, char[]?) Run(string input) => _compiled(input);
}
...
public class TestReturningClassMultiForkTrimMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, (int?, string?, char[]?), string, (int?, string?, char[]?)>>("TrimStringMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassMultiForkSelectorMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<MultiForkSelector<string, (int?, string?, char[]?), string, (int?, string?, char[]?), char[], (int?, string?, char[]?)>>("ClassifyStringContentMutator", 1, selector => (input, branches, defaultNext) =>
        {
            var onlyDigits = !string.IsNullOrEmpty(input) && input.All(char.IsDigit);
            if (onlyDigits) return branches["DigitBranch"](input);
...
public class TestReturningClassMultiForkParseToIntMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, (int?, string?, char[]?), int?, (int?, string?, char[]?)>>("ParseStringToIntMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassMultiForkAddConstantMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<int?, (int?, string?, char[]?), int?, (int?, string?, char[]?)>>("AddConstantMutator", 1, pipe => (input, next) =>
        {
...
public class TestReturningClassMultiForkIntHandlerMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Handler<int?, (int?, string?, char[]?)>>("IntHandlerMutatorDigit", 1, handler => input => handler(input));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassMultiForkAddSpacesMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, (int?, string?, char[]?), string, (int?, string?, char[]?)>>("AddSpacesMutator", 1, pipe => (input, next) =>
        {
            var withAsterisks = $"***{input}***";
            return next(withAsterisks);
        });
...
public class TestReturningClassMultiForkStringHandlerMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Handler<string, (int?, string?, char[]?)>>("StringHandlerMutator", 1, handler => input => handler(input));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassMultiForkRemoveWhitespaceMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, (int?, string?, char[]?), string, (int?, string?, char[]?)>>("RemoveWhitespaceMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassMultiForkConvertToCharArrayMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<string, (int?, string?, char[]?), char[], (int?, string?, char[]?)>>("ConvertToCharArrayMutator", 1, pipe => (input, next) =>
        {
            var inputWithUnderscore = input + "_";
            return next(inputWithUnderscore.ToCharArray());
        });
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassMultiForkRemoveDuplicatesMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<char[], (int?, string?, char[]?), char[], (int?, string?, char[]?)>>("RemoveDuplicatesMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassMultiForkCountDigitsAndLettersMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<char[], (int?, string?, char[]?), (int DigitCount, int LetterCount), (int?, string?, char[]?)>>("CountDigitsAndLettersMutator", 1, pipe => (input, next) => pipe(input, next));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassMultiForkCalculateRatioMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Pipe<(int DigitCount, int LetterCount), (int?, string?, char[]?), int, (int?, string?, char[]?)>>("CalculateRatioMutator", 1, pipe => (input, next) =>
        {
            var ratio = input.LetterCount > 0 ? input.DigitCount / input.LetterCount : input.DigitCount;
            return next(ratio + 2);
        });
...
public class TestReturningClassMultiForkDefaultIntHandlerMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mut = new StepMutator<Handler<int, (int?, string?, char[]?)>>("IntHandlerMutatorDefault", 1, handler => input => handler(input));
        step.Mutators.AddMutator(mut, AddingMode.ExactPlace);
    }
}
...
public class TestReturningClassHandlerMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mutator = new StepMutator<Handler<int, int>>("TestHandlerMutator", 1, handler => input =>
        {
            input += 1;
            return handler(input);
        });
...
public class TestReturningClassLinearMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mutator = new StepMutator<Pipe<int, int, int, int>>("AddConstantMutator", 1, pipe => (input, next) =>
        {
            input *= 2;
            return pipe(input, next);
        });
...
public class TestReturningClassSecondLinearMutator : IMutator<Space>
{
    public void Mutate(Space space)
    {
        ...
        var mutator = new StepMutator<Pipe<int, int, int, int>>("MultiplyByCoefficient", 1, pipe => (input, next) =>
        {
            input += 5;
            return pipe(input, next);
        });
