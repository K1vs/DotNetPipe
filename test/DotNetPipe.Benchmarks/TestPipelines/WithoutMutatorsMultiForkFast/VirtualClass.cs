...
namespace DotNetPipe.Benchmarks.TestPipelines.WithoutMutatorsMultiForkFast;
...
internal class VirtualClass
{
    ...
    protected virtual async ValueTask DigitBranch(string input)
    {
        // ParseStringToInt
        int number;
    ...
    protected virtual async ValueTask LetterBranch(string input)
    {
        // AddSpaces
    ...
    protected virtual async ValueTask SpecialCharBranch(string input)
    {
        // RemoveWhitespace
    ...
    protected virtual async ValueTask DefaultBranch(string input)
    {
    ...
    protected virtual async ValueTask CharArrayHandler(char[] input)
    {
        _consumer.Consume(input);
    }
}
