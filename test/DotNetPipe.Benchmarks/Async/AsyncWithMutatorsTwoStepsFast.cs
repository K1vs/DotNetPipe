...
using DotNetPipe.Benchmarks.Async.TestPipelines.WithMutatorsTwoStepsFast;

namespace DotNetPipe.Benchmarks.Async;

[MemoryDiagnoser]
[Orderer(SummaryOrderPolicy.Declared, MethodOrderPolicy.Declared)]
public class AsyncWithMutatorsTwoStepsFast
{
    ...
    public AsyncWithMutatorsTwoStepsFast()
    {
