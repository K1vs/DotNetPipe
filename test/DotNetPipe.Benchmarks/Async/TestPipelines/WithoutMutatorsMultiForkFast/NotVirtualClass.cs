...
internal class NotVirtualClass
{
    ...
    private async Task ClassifyStringContent(string input)
    {
    ...
    private async Task DigitBranch(string input)
    {
        // ParseStringToInt
        int number;
    ...
    private async Task LetterBranch(string input)
    {
        // AddSpaces
    ...
    private async Task SpecialCharBranch(string input)
    {
        // RemoveWhitespace
    ...
    private async Task DefaultBranch(string input)
    {
    ...
    private async Task CharArrayHandler(char[] input)
    {
        _consumer.Consume(input);
    }
}
