...
using DotNetPipe.Benchmarks.Async.TestPipelines.WithoutMutatorsIfElseFast;

namespace DotNetPipe.Benchmarks.Async;

[MemoryDiagnoser]
[Orderer(SummaryOrderPolicy.Declared, MethodOrderPolicy.Declared)]
public class AsyncWithoutMutatorsIfElseFast
{
    ...
    public AsyncWithoutMutatorsIfElseFast()
    {
