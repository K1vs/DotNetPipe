...
using DotNetPipe.Benchmarks.Async.TestPipelines.WithoutMutatorsOneStepFast;

namespace DotNetPipe.Benchmarks.Async;

[MemoryDiagnoser]
[Orderer(SummaryOrderPolicy.Declared, MethodOrderPolicy.Declared)]
public class AsyncWithoutMutatorsOneStepFast
{
    ...
    public AsyncWithoutMutatorsOneStepFast()
    {
