...
using DotNetPipe.Benchmarks.Sync.TestPipelines.WithoutMutatorsOneStepFast;

namespace DotNetPipe.Benchmarks.Sync;

[MemoryDiagnoser]
[Orderer(SummaryOrderPolicy.Declared, MethodOrderPolicy.Declared)]
public class SyncWithoutMutatorsOneStepFast
{
    ...
    public SyncWithoutMutatorsOneStepFast()
    {
